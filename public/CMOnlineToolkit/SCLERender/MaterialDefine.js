...
//===================================================================================================
var g_cmonlineMtlIDBase = 200000;
var g_newMaterialID = g_cmonlineMtlIDBase;
...
function MeshMaterialData() {
    ...
    this.Default = new ADF_MTL_SAVEDATA();
        ...
        this.Default._MtlData._mtlPhysics.vDiffuse.x = 0.6, this.Default._MtlData._mtlPhysics.vDiffuse.y = 0.6, this.Default._MtlData._mtlPhysics.vDiffuse.z = 0.6,
            this.Default._MtlData._mtlPhysics.vDiffuse.w = 1.0;
        this.Default._MtlData._mtlPhysics.vAmbient.x = 0.6, this.Default._MtlData._mtlPhysics.vAmbient.y = 0.6, this.Default._MtlData._mtlPhysics.vAmbient.z = 0.6,
            this.Default._MtlData._mtlPhysics.vAmbient.w = 1.0; 
        this.Default._MtlData._mtlPhysics.vSpecular.x = 0.6, this.Default._MtlData._mtlPhysics.vSpecular.y = 0.6, this.Default._MtlData._mtlPhysics.vSpecular.z = 0.6,
...
// 平面材质
function PlaneMaterialData() {

    this.clipPlaneMtlRed = new ADF_MTL_SAVEDATA();
    let pureRedColor = new ADF_BASEFLOAT4();
    pureRedColor.x = 0.5, pureRedColor.y = 0.0, pureRedColor.z = 0.0, pureRedColor.w = 0.1,
    this.clipPlaneMtlRed._uMtlID = 200;
        this.clipPlaneMtlRed._strName = "剖切面红色";
        this.clipPlaneMtlRed._MtlData._eMtlType = ADFMTLTYPE_PURECOLOR;
        this.clipPlaneMtlRed._MtlData._mtlPhysics.vEmissive.x = 0.5;
        this.clipPlaneMtlRed._MtlData._mtlPhysics.vEmissive.y = 0.0;
        this.clipPlaneMtlRed._MtlData._mtlPhysics.vEmissive.z = 0.0;
        this.clipPlaneMtlRed._MtlData._mtlPhysics.vEmissive.w = 0.2;
        this.clipPlaneMtlRed._MtlData._arrData.push(pureRedColor);

    this.clipPlaneMtlGreen = new ADF_MTL_SAVEDATA();
    let pureGreenColor = new ADF_BASEFLOAT4();
    pureGreenColor.x = 0.0, pureGreenColor.y = 0.5, pureGreenColor.z = 0.0, pureGreenColor.w = 0.1,
    this.clipPlaneMtlGreen._uMtlID = 201;
        this.clipPlaneMtlGreen._strName = "剖切面蓝色";
        this.clipPlaneMtlGreen._MtlData._eMtlType = ADFMTLTYPE_PURECOLOR;
        this.clipPlaneMtlGreen._MtlData._mtlPhysics.vEmissive.x = 0.0;
        this.clipPlaneMtlGreen._MtlData._mtlPhysics.vEmissive.y = 0.5;
        this.clipPlaneMtlGreen._MtlData._mtlPhysics.vEmissive.z = 0.0;
        this.clipPlaneMtlGreen._MtlData._mtlPhysics.vEmissive.w = 0.2;
        this.clipPlaneMtlGreen._MtlData._arrData.push(pureGreenColor);

    this.clipPlaneMtlBlue = new ADF_MTL_SAVEDATA();
    let pureBlueColor = new ADF_BASEFLOAT4();
    pureBlueColor.x = 0.0, pureBlueColor.y = 0.0, pureBlueColor.z = 0.1, pureBlueColor.w = 0.1,
    this.clipPlaneMtlBlue._uMtlID = 202;
        this.clipPlaneMtlBlue._strName = "剖切面绿色";
        this.clipPlaneMtlBlue._MtlData._eMtlType = ADFMTLTYPE_PURECOLOR;
        this.clipPlaneMtlBlue._MtlData._mtlPhysics.vEmissive.x = 0.0;
        this.clipPlaneMtlBlue._MtlData._mtlPhysics.vEmissive.y = 0.0;
        this.clipPlaneMtlBlue._MtlData._mtlPhysics.vEmissive.z = 0.5;
        this.clipPlaneMtlBlue._MtlData._mtlPhysics.vEmissive.w = 0.2;
        this.clipPlaneMtlBlue._MtlData._arrData.push(pureBlueColor);
}
